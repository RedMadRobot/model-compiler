...
open class FileFinder {
     ...
     */
    open func findFiles(inFolders folders: [String], parameters: ExecutionParameters) throws -> [String] {
        return
            try folders
                .reduce([]) { (files: [String], folder: String) -> [String] in
     ...
     */
    open func findFiles(inFolder folder: String, parameters: ExecutionParameters) throws -> [String] {
        return
